...
<% 
	...
	try
	{
		...
		while(it.hasNext())
		{
			...
			out.print("<div id='letreiroExterno'><div id='letreiroInterno'><label>Senha Atual</label><br>"+g.getUsuario().getNome()+" : "+((Senha)g.getSenhas().get(g.getSenhas().size()-1)).getSenha()+"<label></label></div></div><br>");
		}
	}
	catch(Exception e)
	{
